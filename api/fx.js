...
// "2021-01" / "2021-01-01" → "Jan-21" (matches SALES_MONTHS / EBITDA_MONTHS labels)
...
// usdcad[label] = USD→CAD (≈1.3, the rate the app multiplies USD by to get CAD)
// cadusd[label] = CAD→USD (≈0.77) — returned too for a fallback / sanity check
function pivot(rows) {
